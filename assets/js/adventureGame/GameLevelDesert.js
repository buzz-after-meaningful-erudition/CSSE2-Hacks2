...
class GameLevelDesert {
  constructor(gameEnv) {
    ...
    // 🧱 Falling block with acceleration
    const fallingBlock = new Block(gameEnv);

    // 🎮 Register objects to be updated/rendered
    if (!gameEnv.customObjects) gameEnv.customObjects = [];
    gameEnv.customObjects.push(fallingBlock);

    // 🧩 Classes to instantiate for this level
    this.classes = [
